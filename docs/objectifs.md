...
- ⚙️ **Modularité** : Permettre l'ajout de nouvelles fonctionnalités (Bluetooth, capteurs supplémentaires, accessoires).
...
- 🔄 **Mobilité** : Capacité à avancer, reculer et pivoter.
...
- 🛠️ **Évolutivité** : Code source ouvert (sous licence) et structure CAO modifiable.
